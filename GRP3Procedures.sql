...
CREATE OR REPLACE PROCEDURE AltaActualizarReserva
    (NEW_cod_cliente NUMBER, NEW_cod_hotel NUMBER, NEW_habitacion RESERVA1.habitacion%TYPE, 
    NEW_fecha_inicio DATE, NEW_fecha_fin DATE, NEW_precio RESERVA1.precio%TYPE)
IS
    existeCliente NUMBER;
    existeHotel NUMBER;
    existeReserva NUMBER;
    fechaInicioAntiguaReserva RESERVA1.fecha_inicio%TYPE;
    fechaFinAntiguaReserva RESERVA1.fecha_fin%TYPE;
    hotelAntiguaReserva NUMBER;
    provinciaHotelAntiguaReserva HOTEL1.provincia%TYPE;
    provinciaHotelNuevaReserva HOTEL1.provincia%TYPE;
    totalSencillas NUMBER;
    ocupadasSencillas NUMBER;
    totalDobles NUMBER;
    ocupadasDobles NUMBER;
    precioAntiguaReserva RESERVA1.precio%TYPE;
    habitacionAntiguaReserva RESERVA1.habitacion%TYPE;
BEGIN
...
CREATE OR REPLACE PROCEDURE AnularReserva
    (NEW_cod_cliente NUMBER, NEW_cod_hotel NUMBER, NEW_fecha_inicio RESERVA1.fecha_inicio%TYPE,
    NEW_fecha_fin RESERVA1.fecha_fin%TYPE)
IS
    existeReserva NUMBER;
...
CREATE OR REPLACE PROCEDURE AltaActualizarSuministro
    ...
    NEW_fecha_pedido DATE, NEW_cantidad NUMBER, NEW_precio SUMINISTRA1.precio%TYPE)
IS 
    actualizarSuministro NUMBER;
    provinciaHotel HOTEL1.provincia%TYPE;
    cantidadAnterior SUMINISTRA1.cantidad%TYPE;
    precioAnterior SUMINISTRA1.precio%TYPE;
