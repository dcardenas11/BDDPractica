...
BEGIN
    ...
    IF UPDATING THEN
        IF nHoteles = 0 THEN
            raise_application_error(-10002, 'ERROR: No existe un Hotel con ese codigo');
        END IF;
    END IF;
    ...
    IF (INSERTING) THEN
        ...
        IF (registrosEmpleado > 0) THEN
            ...
            IF (minFechaEmpleado < :NEW.fecha_fin) THEN
                raise_application_error(-10007, 'ERROR: La fecha de fin de un contrato registrado de un empleado no puede ser posterior a la fecha de inicio de su siguiente contrato registrado');    
            END IF;
        END IF;
    END IF;
    ...
    IF (INSERTING) THEN
        ...
        IF (existeContratoActivo>0) THEN
            ...
            IF (:NEW.fecha_inicio > contratoActual) THEN
                raise_application_error(-10008, 'ERROR: La fecha de inicio de un contrato registrado no puede ser posterior a la fecha de inicio de su contrato actual');    
            END IF;
        END IF;
        ...
        IF (registrosEmpleado >0) THEN
            ...
            IF (maxFechaEmpleado > :NEW.fecha_inicio) THEN
                raise_application_error(-10009, 'ERROR: La fecha de incio de un contrato registrado de un empleado no puede ser anterior a la fecha de final de su anterior contrato registrado');    
            END IF;
        END IF;
    END IF;    
END;
...
BEGIN
    ...
    IF UPDATING THEN
        IF nClientes = 0 THEN
            raise_application_error(-10011, 'ERROR: No existe un Cliente con ese codigo');
        END IF;
    END IF;
END;
/
...
BEGIN
    ...
    IF UPDATING THEN
        IF nArticulos = 0 THEN
            raise_application_error(-10013, 'ERROR: No existe un Articulo con ese codigo');
        END IF;
    END IF;
...
BEGIN
    ...
    IF UPDATING THEN
        IF nProveedor = 0 THEN
            raise_application_error(-10017, 'ERROR: No existe un Proveedor con ese codigo');
        END IF;
    END IF;
...
BEGIN
    ...
    IF UPDATING THEN
        IF nVende = 0 THEN
            raise_application_error(-10021, 'ERROR: No existe una Venta con ese Proveedor y Articulo');
        END IF;
    END IF;
...
BEGIN
    ...
    IF UPDATING THEN
        IF nSuministro = 0 THEN
            raise_application_error(-10025, 'ERROR: No existe una Suministro entre esos Proveedor, Articulo y Hotel en esa fecha');
        END IF;
    END IF;
...
BEGIN
    ...
    IF INSERTING THEN
        IF nReserva > 0 THEN
            raise_application_error(-10031, 'ERROR: Ya existe un Reserva de ese Cliente en esa Fecha');
        END IF;
    END IF;
    
    IF UPDATING THEN
        IF nReserva = 0 THEN
            raise_application_error(-10032, 'ERROR: No existe un Reserva de ese Cliente en esa Fecha');
        END IF;
    END IF;
    ...
    IF existeCliente = 0 THEN
        raise_application_error(-10033, 'ERROR: El Cliente que se quiere hacer la Reserva no existe');
    END IF;
    
    SELECT COUNT(*) INTO existeHotel FROM HotelView WHERE cod_hotel=:NEW.cod_hotel;
    
    IF existeHotel = 0 THEN
        raise_application_error(-10034, 'ERROR: El Hotel de la Reserva no existe');
    END IF;
    ...
    IF (UPDATING('fecha_inicio') OR UPDATING('fecha_fin') OR INSERTING) THEN
        ...
        IF reservasCliente > 0 THEN
            raise_application_error(-10038, 'ERROR: El Cliente ya tiene una reserva en otro Hotel para esas Fechas');
        END IF;
    END IF;
END;
/
...
BEGIN
    ...
    IF UPDATING THEN
        IF nEmpleados = 0 THEN
            raise_application_error(-10040, 'ERROR: No existe un Empleado con ese codigo');
        END IF;
    END IF;
