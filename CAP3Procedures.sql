...
IS
    nEmpleados NUMBER;
    nHoteles NUMBER;
    provinciaHotel calabaza2.HOTEL2.PROVINCIA%TYPE;
BEGIN
...
IS
    ...
    provinciaHotel calabaza2.HOTEL2.provincia%TYPE;
    provinciaNuevoHotel calabaza2.HOTEL2.provincia%TYPE;
    nombreEmpleado calabaza2.EMPLEADO2.nombre%TYPE;
    dniEmpleado NUMBER;
...
CREATE OR REPLACE PROCEDURE AltaActualizarReserva
    (NEW_cod_cliente NUMBER, NEW_cod_hotel NUMBER, NEW_habitacion RESERVA2.habitacion%TYPE, 
    NEW_fecha_inicio DATE, NEW_fecha_fin DATE, NEW_precio RESERVA2.precio%TYPE)
IS
    existeCliente NUMBER;
    existeHotel NUMBER;
    existeReserva NUMBER;
    fechaInicioAntiguaReserva RESERVA2.fecha_inicio%TYPE;
    fechaFinAntiguaReserva RESERVA2.fecha_fin%TYPE;
    hotelAntiguaReserva NUMBER;
    provinciaHotelAntiguaReserva HOTEL2.provincia%TYPE;
    provinciaHotelNuevaReserva HOTEL2.provincia%TYPE;
    totalSencillas NUMBER;
    ocupadasSencillas NUMBER;
    totalDobles NUMBER;
    ocupadasDobles NUMBER;
    precioAntiguaReserva RESERVA2.precio%TYPE;
    habitacionAntiguaReserva RESERVA2.habitacion%TYPE;
BEGIN
...
CREATE OR REPLACE PROCEDURE AnularReserva
    (NEW_cod_cliente NUMBER, NEW_cod_hotel NUMBER, NEW_fecha_inicio RESERVA2.fecha_inicio%TYPE,
    NEW_fecha_fin RESERVA2.fecha_fin%TYPE)
IS
    existeReserva NUMBER;
    provinciaHotel HOTEL2.provincia%TYPE;
BEGIN
    SELECT COUNT(*) INTO existeReserva FROM ReservaView
...
CREATE OR REPLACE PROCEDURE AltaNuevoProveedor
    (NEW_cod_proveedor NUMBER, NEW_nombre PROVEEDOR2.nombre%TYPE, NEW_ciudad PROVEEDOR2.ciudad%TYPE)
IS
BEGIN
    CASE
...
IS
    ...
    ciudadProveedor calabaza2.PROVEEDOR2.ciudad%TYPE;
BEGIN
...
CREATE OR REPLACE PROCEDURE AltaActualizarSuministro
    ...
    NEW_fecha_pedido DATE, NEW_cantidad NUMBER, NEW_precio SUMINISTRA2.precio%TYPE)
IS 
    actualizarSuministro NUMBER;
    provinciaHotel HOTEL2.provincia%TYPE;
    cantidadAnterior SUMINISTRA2.cantidad%TYPE;
    precioAnterior SUMINISTRA2.precio%TYPE;
    existeArticulo NUMBER;
    existeHotel NUMBER;
    existeProveedor NUMBER;
    existeVenta NUMBER;
    ciudadProveedor PROVEEDOR2.ciudad%TYPE;
BEGIN 
